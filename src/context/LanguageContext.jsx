...
export const translations = {
  nl: {
    ...
    hero: {
      ...
      surname: "de Smit",
      wave: "👋",
      welcome: "Super leuk je digitaal te ontmoeten en welkom op mijn portfolio website",
    ...
    caseDescriptions: {
      ...
      chocolatemakers: "Custom gebouwede  webshop with a warm and inviting design. Including product configuration for personalized chocolate packages, pick and mix and more.",
      idyl: "Volledig custom built premium lifestyle webshop with sleek design and focus on user experience. Optimized for conversion with fast loading times and intuitive navigation.",
      ananda: "Custom built wellness en lifestyle webshop met rustgevend design. Geoptimaliseerde checkout flow en geïntegreerde email marketing voor klantbehoud.",
      ...
      spriet: "Moderne Nederlandse webshop met focus op duurzaamheid. Clean design met uitgebreide productfiltering en snelle mobiele ervaring.",
      ...
      graylabel: "Duurzame kinderkleding webshop met organische materialen. Clean design met focus op merkidentiteit en gebruiksvriendelijke shopervaring.",
    },
    // Contact
    contact: {
      title: "Contact",
